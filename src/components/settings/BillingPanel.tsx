...
const planData: Record<string, { name: string; price: string; features: string[]; badge: string }> = {
  free: {
    ...
    features: ['Sinirli tahmin erisimi', 'Temel mac verileri', 'Topluluk destegi'],
  },
  pro: {
    name: 'Pro',
    price: '299 TL/ay',
    badge: 'text-blue-700 bg-blue-50 border-blue-200',
    features: ['Tum tahminlere erisim', 'AI Debate goruntulemesi', 'Oncelikli destek', 'API erisimi (1000 istek/ay)'],
  },
  elite: {
    name: 'Elite',
    price: '999 TL/ay',
    badge: 'text-gold-700 bg-gold-50 border-gold-200',
    features: ['Sinirsiz tahmin erisimi', 'Gercek zamanli bildirimler', 'Ozel raporlama', 'API erisimi (sinirsiz)', 'Ozel destek yoneticisi'],
  },
  b2b_only: {
    name: 'B2B',
    price: 'Ozel Fiyat',
    badge: 'text-navy-700 bg-navy-50 border-navy-200',
    features: ['White-label cozum', 'Ozel API entegrasyonu', 'SLA garantisi', 'Ozel egitim ve destek'],
  },
};

const invoiceStatus: Record<string, { label: string; color: string }> = {
  paid: { label: 'Odendi', color: 'text-emerald-700 bg-emerald-50 border-emerald-200' },
  ...
  void: { label: 'Iptal', color: 'text-red-700 bg-red-50 border-red-200' },
};
    ...
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div className="flex items-center gap-3 p-4 rounded-lg border border-dashed border-gray-300 text-gray-400">
          ...
          <span className="text-sm">Odeme yontemi eklenmedi</span>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Fatura Gecmisi</h3>
        {invoices.length === 0 ? (
          <p className="text-sm text-gray-400 py-4 text-center">Fatura bulunamadi</p>
        ) : (
            ...
            <table className="w-full min-w-[480px]">
              <thead>
                <tr className="border-b border-gray-100">
                  ...
                  <th className="text-left text-xs font-medium text-gray-500 pb-2">Aciklama</th>
