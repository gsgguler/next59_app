    ...
    <div className="min-h-screen bg-navy-950">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-readable-muted">Bize ulaşın.</p>
            </div>
          </div>
        </div>
      </div>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="bg-navy-900/50 border border-navy-800 rounded-xl p-6 max-w-sm">
          <p className="text-xs text-readable-muted uppercase tracking-wider mb-2">E-posta</p>
          <p className="text-sm text-navy-300 leading-relaxed">
            İletişim bilgileri yakında güncellenecek.
          </p>
        </div>
        <p className="mt-6 text-xs text-readable-muted">
