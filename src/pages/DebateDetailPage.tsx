    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          ...
          <p className="text-gray-500 mt-0.5">
            {homeName && awayName ? `${homeName} vs ${awayName}` : 'Mac degerlendirmesi'}
            {cassCode && ` - ${cassCode}`}
          </p>
        </div>
      ...
      {useMock && (
        <div className="bg-amber-50 border border-amber-200 rounded-lg px-4 py-3 text-sm text-amber-700">
          Gercek debate verisi bulunamadi. Demo veriler gosterilmektedir.
        </div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        <div className="lg:col-span-3">
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-6">Degerlendirme Sureci</h2>
        ...
        <div className="lg:col-span-2 space-y-6">
          {prediction && (
            <div className="bg-white rounded-xl border border-gray-200 p-5">
              <h3 className="text-sm font-semibold text-gray-900 mb-3">Tahmin Ozeti</h3>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5">
            <h3 className="text-sm font-semibold text-gray-900 mb-3">Tur Ozeti</h3>
