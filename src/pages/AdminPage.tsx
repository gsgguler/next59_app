    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        >
          ...
          <div>
            <p className="text-sm font-semibold text-white group-hover:text-champagne transition-colors">Operasyonlar</p>
            <p className="text-xs text-readable-muted">Yayın kuyruğu, veri tazeliği ve sistem sağlığı</p>
          </div>
        </Link>
        <Link
          to="/admin/model-lab"
