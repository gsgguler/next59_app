...
// Fetch /fixtures/events for a given league+season in chunks.
// Stores raw responses only — normalization runs via af_normalize_fixture_events() SQL fn.
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    // Load pilot matches for this league+season
