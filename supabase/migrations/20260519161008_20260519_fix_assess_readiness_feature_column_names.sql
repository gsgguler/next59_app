/*
  # Fix assess_upcoming_match_readiness — correct column names in feature tables

  ## Problems
  1. prematch_upcoming_feature_snapshots: referenced matches_l5_home/matches_l5_away
     but actual columns are home_matches_l5 / away_matches_l5
  2. match_feature_matrix_v2: referenced home_l5_matches_available / away_l5_matches_available
     which do not exist — default to 0
*/
...
-- 1. ELO (model_lab.team_elo_ratings)
...
-- 2. Feature readiness
-- Primary: prematch_upcoming_feature_snapshots (home_matches_l5, away_matches_l5)
...
ELSE
  -- Fallback: match_feature_matrix_v2 (no l5 count columns — default 0)
  SELECT feature_quality_tier, has_form_features
  INTO v_feature
