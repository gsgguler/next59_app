/*
  # ELO V1 — Fix column reference: match_date → kickoff_utc
  v_calibration_safe_matches uses kickoff_utc (date) not match_date.
  All logic and parameters unchanged.
*/
  ...
  LOOP
    ...
    FOR v_match IN
      SELECT
        ...
        csm.competition_name  AS cname,
        csm.season_label,
        csm.kickoff_utc       AS match_date,   -- view column name
        csm.home_team_id,
        csm.home_team_name,
        csm.away_team_id,
        csm.away_team_name,
